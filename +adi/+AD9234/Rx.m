classdef Rx < adi.AD9234.Base & adi.common.Rx
    % adi.AD9234.Rx Receive data from the AD9234 high speed ADC
    %   The adi.AD9234.Rx System object is a signal source that can receive
    %   complex data from the AD9234.
    %
    %   rx = adi.AD9234.Rx;
    %   rx = adi.AD9234.Rx('uri','192.168.2.1');
    %
    %   <a href="http://www.analog.com/media/en/technical-documentation/data-sheets/AD9234.pdf">AD9234 Datasheet</a>
    %
    %   See also adi.DAQLES.Rx
    ...
    methods
        ...
        function obj = Rx(varargin)
            ...
            obj = obj@adi.AD9234.Base(varargin{:});
        end
    end
